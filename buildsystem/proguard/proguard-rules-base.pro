...
# https://stackoverflow.com/a/7587680/3171537
...
# https://stackoverflow.com/a/30363458/3171537
...
#-keepclassmembers class com.uh.hospital.base.BaseWebViewActivity$BaseWebAppInterface {
#   public *;
#}
-keepclassmembers class com.jiajia.badou.activity.CommonWebViewActivity$BaseWebAppInterface {
   public *;
}
...
#-keep class com.uh.hospital.bean.** {*;}
#Custom View
#-keep class com.uh.hospital.view.**{*;}
-keep class com.jiajia.badou.view.**{*;}
-keep class com.jiajia.badou.bean.**{*;}
-keep class com.jiajia.presenter.bean.**{*;}
-keep class com.jiajia.presenter.modle.**{*;}

# http://stackoverflow.com/a/31851024/3171537
#-keepclassmembers class com.uh.hospital.bean.** {<fields>;}
...
-keep public class com.qiantu.youqian.R$*{
    public static final int *;
}

-keep public class com.qiantu.youqian.data.R$*{
    public static final int *;
}

-keep public class com.qiantu.android.common.android.view.R$*{
    public static final int *;
}

-keep public class com.qiantu.android.common.android.util.R$*{
    public static final int *;
}
